<%@page import="com.rays.pro4.controller.ABCCtl"%>
		...
		<form action="<%=ORSView.ABC_CTL%>" method="post">
			...
			<div align="center">
				<h1>
					...
					%>
					<tr>
						<th><font size="5px"> Update ABC </font></th>
					</tr>
					<%
						} else {
					%>
					<tr>
						<th><font size="5px"> Add ABC</font></th>
					</tr>
					<%
						}
					%>
			...
			<tr>
				...
				<td align="right" colspan="2">&nbsp; &emsp; <input
					type="submit" name="operation" value="<%=ABCCtl.OP_UPDATE%>">
					&nbsp; &nbsp; <input type="submit" name="operation"
					value="<%=ABCCtl.OP_CANCEL%>"></td>
				...
				<td align="right" scolspan="2">&nbsp; &emsp; <input
					type="submit" name="operation" value="<%=ABCCtl.OP_SAVE%>">
					&nbsp; &nbsp; <input type="submit" name="operation"
					value="<%=ABCCtl.OP_RESET%>"></td>
