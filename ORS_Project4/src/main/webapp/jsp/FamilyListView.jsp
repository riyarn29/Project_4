...
<%@page import="com.rays.pro4.controller.FamilyListCtl"%>
<%@page import="com.rays.pro4.Bean.FamilyBean"%>
...
<body>
	...
	<form action="<%=ORSView.FAMILY_LIST_CTL%>" method="post">
		<center>
  ...
  --%>
					<input type="submit" name="operation"
						value="<%=FamilyListCtl.OP_SEARCH%>"> &nbsp;
					<input type="submit" name="operation"
						value="<%=FamilyListCtl.OP_RESET%>">
					</td>
				</tr>
			</table>
			<br>
			...
			<table border="1" width="100%" align="center" cellpadding=6px
				...
				<tr align="center">
					...
					<td><a href="FamilyCtl?id=<%=bean.getId()%>">Edit</a></td>
				</tr>
				<%
					}
				%>
			...
			<table width="100%">
				...
				<tr>
					...
					<td><input type="submit" name="operation" disabled="disabled"
						value=<%=FamilyListCtl.OP_PREVIOUS%>></td>
					<%
						} else {
					%>
					...
					<td><input type="submit" name="operation"
						value=<%=FamilyListCtl.OP_DELETE%>></td>
					<td><input type="submit" name="operation"
						value=<%=FamilyListCtl.OP_NEW%>></td>


					<td align="right"><input type="submit" name="operation"
						value=<%=FamilyListCtl.OP_NEXT%>
			...
			<td align="center"><input type="submit" name="operation"
				value=<%=FamilyListCtl.OP_BACK%>></td>
			<%
				}
			%>
