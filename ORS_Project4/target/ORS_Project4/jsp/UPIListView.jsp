...
<%@page import="com.rays.pro4.Bean.UPIBean"%>
...
<body>
	...
	<form action="<%=ORSView.UPI_LIST_CTL%>" method="post">
		<center>
			...
			<%
				...
				Iterator<UPIBean> it = list.iterator();
  ...
  --%>
						...
						value="<%=UPIListCtl.OP_SEARCH%>"> &nbsp; <input
						type="submit" name="operation" value="<%=UPIListCtl.OP_RESET%>"></td>
				</tr>
			</table>
			<br>
			...
			<table border="1" width="100%" align="center" cellpadding=6px
				...
				<tr align="center">
					...
					<td><a href="UPICtl?id=<%=bean.getId()%>">Edit</a></td>
				</tr>
				<%
					}
				%>
			...
			<table width="100%">
				...
				<tr>
					...
					<td><input type="submit" name="operation" disabled="disabled"
						value=<%=UPIListCtl.OP_PREVIOUS%>></td>
					<%
						} else {
					%>
					...
					<td><input type="submit" name="operation"
						value=<%=UPIListCtl.OP_DELETE%>></td>
					<td><input type="submit" name="operation"
						value=<%=UPIListCtl.OP_NEW%>></td>

				
					<td align="right"><input type="submit" name="operation"
						value=<%=UPIListCtl.OP_NEXT%>
